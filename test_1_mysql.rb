...
DB = if RUBY_PLATFORM =~ /java/
  Sequel.connect("jdbc:mysql://localhost/datastore_test_1?user=mark", max_connections: THREAD_COUNT + 4)
else
  Sequel.connect("mysql2://localhost/datastore_test_1", max_connections: THREAD_COUNT + 4)
end
